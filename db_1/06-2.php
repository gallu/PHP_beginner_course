...
// XXX 悪意ある文字列
$data = "1;INSERT INTO practice_5(data) VALUES('crack');--";
$data2 = "<script>alert('test');</script>"; // XXX 後で使う「XSS用」の悪意ある文字列
$num = 100;
...
// 確認用のSQL
// -- 文字が少し長いので、 \G のほうが見やすいのでそのように
// SELECT * FROM practice_6 \G
