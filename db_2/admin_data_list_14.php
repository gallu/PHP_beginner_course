...
<?php endif; ?>
  ...
  <div class="row">
  <form action="./admin_data_list.php">
    <div>
      <span class="col-md-4">検索する「名前」<input name="" value=""></span>
      <span class="col-md-8">検索する「誕生日(YYYY-MM-DD)」<input name="" value="">～<input name="" value=""></span>
    </div>
    <div>
      <span class="col-md-12">検索する「入力日(YYYY-MM-DD)」<input name="" value=""></span>
    </div>
