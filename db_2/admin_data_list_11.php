...
<?php endif; ?>
  ...
  <tr>
    <td><a class="bg-danger text-danger" href="./admin_data_list.php?sort=test_form_id">▲</a>　<a class="text-muted" href="./admin_data_list.php?sort=test_form_id_desc">▼</a>
    <td><a class="text-muted" href="./admin_data_list.php?sort=name">▲</a>　<a class="text-muted" href="./admin_data_list.php?sort=name_desc">▼</a>
    <td><a class="text-muted" href="./admin_data_list.php?sort=created">▲</a>　<a class="text-muted" href="./admin_data_list.php?sort=created_desc">▼</a>
    <td><a class="text-muted" href="./admin_data_list.php?sort=updated">▲</a>　<a class="text-muted" href="./admin_data_list.php?sort=updated_desc">▼</a>
