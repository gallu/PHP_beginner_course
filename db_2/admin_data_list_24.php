...
<?php endif;?>
  ...
  <div class="row">
    <?php if (1 != $page_num): ?>
      <a class="btn btn-default" href="./admin_data_list.php?p=<?php echo ($page_num - 1); ?>">＜＜前</a>
    <?php endif; ?>
    　
    <?php if ($max_page_num > $page_num): ?>
      <a class="btn btn-default" href="./admin_data_list.php?p=<?php echo ($page_num + 1); ?>">次＞＞</a>
    <?php endif; ?>
  </div>
  ...
  <div class="row">
    ...
    <?php for($i = 1; $i <= $max_page_num; ++$i): ?>
        ...
        <?php else: ?>
            <li><a href="./admin_data_list.php?p=<?php echo $i; ?>"><?php echo $i; ?></a></li>
        <?php endif; ?>
    <?php endfor; ?>
    </ul>
  </div>
